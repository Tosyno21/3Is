  ...
  return (
    <section className="">
      ...
      <ServiceCard
        ...
        imageUrl={"/services/event marketing.jpg"}
      />
      <ServiceCardV2
        ...
        imageUrl={"/services/pop culture marketing.jpg"}
      />
      <ServiceCard
        title={"COPYWRITING"}
        description={
      ...
      <ServiceCardV2
        ...
        imageUrl={"/services/creative design.png"}
      />
      <ServiceCard
        ...
        imageUrl={"/services/content creation.jpg"}
      />
      <ServiceCardV2
        ...
        imageUrl={"/services/Influencer Marketing.jpg"}
      />
      <ServiceCard
        title={
          "EVENT PRODUCTION & BOOTH FABRICATION: BRINGING YOUR BRAND TO LIFE"
        }
        description={
        ...
        imageUrl={"/services/event production.png"}
      />
    </section>
  );
}
